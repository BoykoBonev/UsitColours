...
namespace UsitColours.Tests.MVC.Controllers.ProfileControllerTests
{
    ...
    class UpcommingFlights_Should
    {
        ...
        public void CallGetFlightHistoryOnUserSeriveWithProvidedUserId(string userId)
        {
            ...
            // Act
            profileController.UpcommingFlights();

            // Assert
            mockedUserService.Verify(u => u.GetUpcommingFlights(userId), Times.Once);
        }
        ...
        public void CallMapOnMappingServiceOnProvidedFlightCollection()
        {
            ...
            mockedUserService.Setup(u => u.GetUpcommingFlights(It.IsAny<string>())).Returns(flights);
        ...
        public void ReturnPartialView_FlightList_WithProvidedVIewModel()
        {
            ...
            // Act and Assert
            profileController
               .WithCallTo(h => h.UpcommingFlights())
